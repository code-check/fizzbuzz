...
- *Use [fizzbuzz.rb](https://github.com/code-check/fizzbuzz/blob/ruby/app/fizzbuzz.rb) for solving the challenge*
- *See [fizzbuzztest.rb](https://github.com/code-check/fizzbuzz/blob/ruby/test/fizzbuzztest.rb) for seeing the tests*
- FizzBuzz Logic,
  - If the number is
