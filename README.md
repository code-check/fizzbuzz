...
- *Use [fizzbuzz.js](https://github.com/code-check/fizzbuzz/blob/js/app/fizzbuzz.js) for solving the challenge*
- *See [fizzbuzztest.js](https://github.com/code-check/fizzbuzz/blob/js/test/fizzbuzztest.js) for seeing the tests*
- FizzBuzz Logic,
  - If the number is
