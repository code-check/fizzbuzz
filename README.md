...
- *Use [fizzbuzz.cpp](https://github.com/code-check/fizzbuzz/blob/c%2B%2B/app/fizzbuzz.cpp) for solving the challenge*
- *See [fizzbuzztest.js](https://github.com/code-check/fizzbuzz/blob/c%2B%2B/test/fizzbuzztest.js) for seeing the tests*
- FizzBuzz Logic,
  - If the number is
