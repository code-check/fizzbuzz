...
- *Use [fizzbuzz.py](https://github.com/code-check/fizzbuzz/blob/python/app/fizzbuzz.py) for solving the challenge*
- *See [testfizzbuzz.py](https://github.com/code-check/fizzbuzz/blob/python/test/testfizzbuzz.py) for seeing the tests*
- FizzBuzz Logic,
  - If the number is
